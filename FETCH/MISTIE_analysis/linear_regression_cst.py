...
cst_path = '/Users/oliviamurray/Documents/MISTIE_inference/output_full_2_txt.xlsx'
save_path = '/Users/oliviamurray/Documents/MISTIE_inference/linear_reg_full.xlsx'

df = pd.read_excel(bios_path)
df_sorted = pd.read_excel(bios_sorted_path)
df_sop = pd.read_excel(cst_path)
...
filtered_df = df_sop.merge(df, left_on="transformed ID", right_on="patientnum_ninds")
...
filtered_df = filtered_df.merge(df_sorted, left_on = "transformed ID", right_on = "patientnum_ninds" )
print(filtered_df)
"""
...
filtered_columns = ["ID","treatment_group", "age_at_consent", "male_gender", 
                    "diagct_ivh_volume", "Log ICH volume", "binary dice","dice", "flip dice", "binary flip dsc", "binary combined dsc" ,"split tract" ,"tract asymmetry","added_nihss_1", "added_nihss_180", 
                    "SIS impairment d180", "SIS function d180" ,"NIHSS log gradient", "NIHSS gradient", "NIHSS extent", "NIHSS extent binary", "glasgow_rankin_365", "glasgow_rankin_30"]
...
df_surg.to_excel('/Users/oliviamurray/Documents/MISTIE_inference/logistic_regression_surgical.xlsx', index=False)
df_not_involved = filtered_df[filtered_df["binary dice"] == 0]
df_not_involved.to_excel('/Users/oliviamurray/Documents/MISTIE_inference/logistic_not_involved.xlsx', index=False)