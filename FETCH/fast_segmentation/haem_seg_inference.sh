...
do 
    ...
    nnUNet_predict -i /mnt/iusers01/ct01/p09383om/scratch/selected_ct_lumc/${patient_id} -o /mnt/iusers01/ct01/p09383om/scratch/lumc_haematoma_segs/${patient_id} -tr nnUNetTrainerV2  -m 3d_fullres -p nnUNetPlansv2.1 -t Task501_Haemorrhage
done